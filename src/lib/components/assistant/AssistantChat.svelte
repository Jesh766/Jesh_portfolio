...
<section class="assistant-card" aria-label={mode === 'editor' ? 'Portfolio editing assistant' : 'Analytics assistant'}>
	<div class="assistant-heading">
		<div>
			<p class="assistant-kicker">Jesh Admin Copilot</p>
			<h3>{mode === 'editor' ? 'Editing mode' : 'Analytics mode'}</h3>
		</div>
...
<style>
	...
	.assistant-heading, .assistant-actions { display: flex; align-items: center; justify-content: space-between; gap: .75rem; }
